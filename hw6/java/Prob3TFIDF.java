...
public class Prob3TFIDF extends Configured implements Tool{
    public static String dlt = " ";

    public static class Prob3TFIDFMap extends Mapper<LongWritable, Text, Text, Text> {
    ...
    public static class Prob3TFIDFReduce extends Reducer<Text, Text, Text, Text> {
        public static Text myVal = new Text();
        public static Text myKey = new Text();
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "Prob3TFIDF");
        job.setJarByClass(Prob3TFIDF.class);
      
        job.setOutputKeyClass(Text.class);
        job.setOutputValueClass(Text.class);

        job.setMapperClass(Prob3TFIDF.Prob3TFIDFMap.class);
        job.setReducerClass(Prob3TFIDF.Prob3TFIDFReduce.class);
    ...
    public static void main(String[] args) throws Exception{
        int res = ToolRunner.run(new Configuration(), new Prob3TFIDF(), args);
        System.exit(res);
    }
}
